...
interface MessageComponentProps {
    message: MessageDto & {placeholder?: boolean}
...
export const MessageComponent: React.FC<MessageComponentProps> = (props) => {
    ...
    const colors = {
        sent: darken(theme.palette.primary.main, 0.7),
        received: theme.palette.divider,
    }
    ...
    return (
        <Box
            sx={{ flexDirection: "column", paddingTop: props.same_as_previous ? 0.5 : 1, paddingBottom: props.last_message ? 3 : undefined }}
        ...
        >
                    ...
                    (props.message.author ? (
                        <Box sx={{ alignItems: "center", gap: 1 }}>
                            <Avatar sx={{ bgcolor: "primary.main", width: 30, aspectRatio: 1, height: "auto" }}>
                                {props.message.author.username.charAt(0).toUpperCase()}
                            </Avatar>
                        ...
                        <Typography>usuário removido</Typography>
                    ))}
            ...
            <Box
                sx={{
                    ...
                    opacity: props.message.placeholder ? 0.5 : 1,
            ...
            >
                <Typography
                    ...
                    variant="subtitle2"
                    sx={{
                        color: isLink ? "inherit" : "text.secondary",
